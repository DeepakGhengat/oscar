...
[![Tests](https://img.shields.io/badge/tests-367%20passing-2ea043)](#development)
...
- **One dependency, no build step.** TypeScript run through `tsx`; 367 offline tests.
...
```bash
npm install
npm test          # 367 tests, entirely offline
npm run typecheck
